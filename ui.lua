    ...
    function window:page(cfg)
        ...
        function page:section(cfg)
            ...
            function section:screen(cfg)
                ...
                -- // Drawings
                local holder = library:create("Square", {Parent = section_content, Visible = true, Transparency = 0.5, Size = UDim2.new(1,0,1,0), Thickness = 1, Filled = false, ZIndex = 14});
                --
                local title = library:create("Text", {
                    Text = name,
                    Font = Drawing.Fonts.Plex,
...
function library:createwatermark(info)
    ...
    watermark.objects.text2 = library:create("Text", { Parent = watermark.objects.background, Visible = true, Transparency = 1, Theme = "Accent", Size = 13, Text = 'meow hub', Center = false, Outline = false, Font = Drawing.Fonts.Plex, Position = UDim2.new(0, 3,0,2), ZIndex = 11})
